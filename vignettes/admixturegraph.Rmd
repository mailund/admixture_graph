...
```{r, warning=FALSE, cache=TRUE, dependson="bears_graph", fig.height=5, fig.width=5}
data(bears)

bears_fit <- fit_graph(bears, bears_graph, optimset(MaxFunEvals = 100000, MaxIter = 100000))
plot(bears_fit)
```
