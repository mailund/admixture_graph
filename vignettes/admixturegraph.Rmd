...
```{r, cache = TRUE}
logBF <- model_bayes_factor_n(thinned_1[, "likelihood"], thinned_2[, "likelihood"], 100)
logBF
```

The result here shows a non-significant support (Bayes factor `r round(logBF[1], digits = 2)` [sd +/- `r round(logBF[2], digits = 2)`]) for the first model compared to the second.
