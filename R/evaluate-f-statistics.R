...
#'
#' @return A list containing two values: "edges", a vector of edges and "admix_prop", 
#' a vector containing admixture proportions.
#'
#' @export
...
#'
#' @return A list containing two values: "edges", a vector of edges and "admix_prop", a vector containing 
...
#'
#' The data frame, \code{data}, must contain columns \code{W}, \code{X}, \code{Y}, and \code{Z}. 
#' The function then computes the f4(W,X;Y,Z) statistics for all rows and adds these as a column,
#' \code{graph_f4}, to the data frame.
#'
